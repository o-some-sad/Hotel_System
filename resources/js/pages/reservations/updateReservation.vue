...
// Add watch to show the changes if date changes
...
// Initialize selectedRoom with current room
onMounted(() => {
    selectedRoom.value = availableRooms.value.find(room => room.id === parseInt(form.room_id));
});
...
<template>
    <div class="container mx-auto py-8 px-4">
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6 text-center">Update Reservation</h1>
            ...
            <form @submit.prevent="onSubmit">
                ...
                <div class="mb-4">
                    ...
                    <p v-if="form.errors.accompanying_number" class="mt-1 text-sm text-red-600">
                        {{ form.errors.accompanying_number }}</p>
                </div>
